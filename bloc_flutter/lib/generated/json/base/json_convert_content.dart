...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
      case BaseNewsEntity:
        return baseNewsEntityFromJson(data as BaseNewsEntity, json) as T;
      case ToutiaoNewsReqEntity:
        return toutiaoNewsReqEntityFromJson(data as ToutiaoNewsReqEntity, json) as T;
      case ToutiaoRoot:
        return toutiaoRootFromJson(data as ToutiaoRoot, json) as T;
  ...
  static _getToJson<T>(Type type, data) {
    switch (type) {
      case BaseNewsEntity:
        return baseNewsEntityToJson(data as BaseNewsEntity);
      case ToutiaoNewsReqEntity:
        return toutiaoNewsReqEntityToJson(data as ToutiaoNewsReqEntity);
      case ToutiaoRoot:
        return toutiaoRootToJson(data as ToutiaoRoot);
      case ToutiaoNewsRespEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {
      case 'BaseNewsEntity':
        return BaseNewsEntity().fromJson(json);
      case 'ToutiaoNewsReqEntity':
        return ToutiaoNewsReqEntity().fromJson(json);
      case 'ToutiaoRoot':
        return ToutiaoRoot().fromJson(json);
      case 'ToutiaoNewsRespEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {
      case 'BaseNewsEntity':
        return List<BaseNewsEntity>();
      case 'ToutiaoNewsReqEntity':
        return List<ToutiaoNewsReqEntity>();
      case 'ToutiaoRoot':
        return List<ToutiaoRoot>();
      case 'ToutiaoNewsRespEntity':
